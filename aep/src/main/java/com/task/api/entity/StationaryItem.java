...
public class StationaryItem {
    ...
    public StationaryItem(List<StationaryItem> excelData) {

//        this.name = excelData.getName();
//       this.code =excelData.getCode();
//        this.uom =excelData.getUom();
//        this.viewedBy = excelData.getViewedBy();
//        this.alertCount = excelData.getAlertCount();
//
    }

    public StationaryItem(String name, int number1, Object stringValue, Object stringValue1, int number11) {
    }
...
//	public StationaryItem(List<StationaryItem> itemRequest) {
//
...
//    public StationaryItem(List<StationaryItemRequest> excelData) {
//        this.name = excelData.getName();
//        this.code =excelData.getCode();
//        this.uom =exc.getUom();
//        this.viewedBy = itemRequest.getViewedBy();
...
//  public StationaryItem(String stringValue, int number1, String stringValue1, String stringValue2, int number11) {
//    }
